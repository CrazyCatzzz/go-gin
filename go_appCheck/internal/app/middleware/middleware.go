...
func NoRoute() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.JSON(http.StatusNotFound, response.NewResponseWithMsg(response.MsgNoRoute))
		c.Abort()
	}
}
...
func NoMethod() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.JSON(http.StatusBadRequest, response.NewResponseWithMsg(response.MsgNoRoute))
		c.Abort()
	}
}
